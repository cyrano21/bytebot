...
Bytebot supports multiple AI models:
...
3. Add your OpenRouter API key to environment variables:
   ```bash
   export OPENROUTER_API_KEY=sk-or-v1-...
   ```

4. Configure models in `models.toml`:
   ```toml
   [models]
   ollama_qwen3-30b = "qwen3:30b"
   openrouter_llama3_1-8b = "meta-llama/llama-3.1-8b-instruct:free"
   
   [default]
   model = "ollama_qwen3-30b"
   ```

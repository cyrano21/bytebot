...
export class InputCaptureService {
  ...
  start(taskId: string) {
    ...
    // The desktop service multiplexes Socket.IO and websockify on the same
    // public port. For input capture, staying on HTTP long-polling avoids
    // websocket upgrades being intercepted by the VNC proxy.
